...
namespace Entity.model.config
{
...

    {
        public void Configure(EntityTypeBuilder<UserInfo> builder)
        {
            ...
            builder.Property(a => a.PhotoUrl).HasMaxLength(100).HasDefaultValue("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR615GBUSZb8GeFZXD70nTOYodrPGHwmu19IA&s");
        }
    }
}
